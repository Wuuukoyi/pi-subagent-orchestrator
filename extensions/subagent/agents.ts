...
export function discoverAgents(cwd: string, scope: AgentScope): AgentDiscoveryResult {
	...
	// Agents bundled inside this package. Always loaded as the base layer,
	// so the package works out of the box with no manual copying.
	const packageAgents = loadAgentsFromDir(PACKAGE_AGENTS_DIR, "user");
